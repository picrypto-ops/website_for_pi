...
echo "<div class='section'>
    <h2>Configuration</h2>
    <p>Using configuration from: <code>bem-config.php</code></p>
...
if (!$foundOriginalCss) {
    ...
    echo "<ol>
        ...
        <li>Update bem-config.php with the correct paths for your environment</li>
    </ol>";
}
...
if ($foundOriginalCss && $foundBemCss) {
    ...
    echo "<ol>
        <li>Check if the web URLs in bem-config.php are correct</li>
...
echo "<div class='section'>
    ...
    <ul>
        ...
        <li>Update paths in bem-config.php to match your server structure</li>
    </ul>
    ...
    <ul>
        <li>Update bem-config.php with absolute paths relative to the document root</li>
